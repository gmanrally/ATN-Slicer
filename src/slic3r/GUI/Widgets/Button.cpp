    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x0a8c8c, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#0a8c8c", "#0a8c8c"};
wxString btn_confirm[10]  = {"#DFDFDF", "#0a8c8c", "#26A69A", "#0a8c8c", "#0a8c8c", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#22bfb0", "#00FFD4"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#0a8c8c", "#0a8c8c"};
