...
/*#ifdef __WXOSX__
    ...
    StateColor box_border_colour(std::pair<wxColour, int>(wxColour("#0a8c8c"), StateColor::Normal)); // ORCA match border color with other input/combo boxes
...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Support"), "custom-gcode_support"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("detect_floating_extrusions");
    ...
    page = add_options_page(L("Others"), "custom-gcode_other"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("brim_merge_supports", "others_settings_brim#merge-part-support-brims");
